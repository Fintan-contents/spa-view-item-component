...
export const selectComponent = (
  ...
  if (item instanceof CsInputTextItem) {
    const props: BSxProps<CsInputTextItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputNumberItem) {
    const props: BSxProps<CsInputNumberItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsTextAreaItem) {
    const props: BSxProps<CsTextAreaItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsCheckBoxItem) {
    const props: BSxProps<CsCheckBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputPasswordItem) {
    const props: BSxProps<CsInputPasswordItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsRadioBoxItem) {
    const props: BSxProps<CsRadioBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsSelectNumberBoxItem) {
    const props: BSxProps<CsSelectNumberBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsSelectBoxItem) {
    const props: BSxProps<CsSelectBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsMultiCheckBoxItem) {
    const props: BSxProps<CsMultiCheckBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputDateItem) {
    const props: BSxProps<CsInputDateItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputNumberRangeItem) {
    const props: BSxProps<CsInputNumberRangeItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputDateRangeItem) {
    const props: BSxProps<CsInputDateRangeItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
