 ...
 */
const meta: Meta<typeof MxInputPassword> = {
  title: "Material UI/MxInputPassword",
  component: MxInputPassword,
  tags: ["autodocs"],
  argTypes: {
    item: {
      control: false,
...
const defaultArgs: Partial<MxInputPasswordProps> = {
  item: undefined,
  hideLabel: false,
  labelPlacement: "top",
  labelWidth: 30,
...
/**
 * MxInputPasswordコンポーネントのサンプル。
 */
export const InputPassword: Story = {
  args: defaultArgs,
  render: function Render(args: MxInputPasswordProps) {
    ...
    return <MxInputPassword {...args} item={item} />;
  },
  tags: ["!autodocs", "!dev"],
  parameters: {
    docs: {
...
const CustomizeItemParameters = () => {
  ...
  return (
    <>
      <MxInputPassword item={targetItem} />
      <hr />
