...
export abstract class CsLoadEvent<
...
export abstract class CsQueryLoadEvent<
  TApiResponse,
  TApiError = unknown,
> extends CsLoadEvent<TApiResponse, TApiError> {
  abstract reload(): void;
}

export abstract class CsMutateLoadEvent<
  TApiResponse,
  TApiError = unknown,
> extends CsLoadEvent<TApiResponse, TApiError> {
  abstract start(): void;
...
export abstract class CsActionEvent<
  TApiResponse = unknown,
  TApiError = unknown,
> extends CsEvent {
  abstract get isLoading(): boolean;
