...
export const stringCustomValidationRule = (
  validator: CustomValidator<string>,
  message: CustomValidateMessage<string>,
) => {
  return new CustomValidationRule(validator, message, (value) => {
    if (value === undefined) {
      return true;
    }
...
export const numberCustomValidationRule = (
  validator: CustomValidator<number>,
  message: CustomValidateMessage<number>,
) => {
  return new CustomValidationRule(validator, message, (value) => {
    if (value === undefined) {
      return true;
...
export const booleanCustomValidationRule = (
  validator: CustomValidator<boolean>,
  message: CustomValidateMessage<boolean>,
) => {
  return new CustomValidationRule(validator, message, (value) => {
    if (value === undefined) {
      return true;
...
export const stringArrayCustomValidationRule = (
  validator: CustomValidator<string[]>,
  message: CustomValidateMessage<string[]>,
) => {
  return new CustomValidationRule(validator, message, (value) => {
