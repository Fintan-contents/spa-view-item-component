 ...
 */
const meta: Meta<typeof BSxTextArea> = {
  title: "Bootstrap/BSxTextArea",
  component: BSxTextArea,
  tags: ["autodocs"],
  argTypes: {
    item: {
      control: false,
...
const defaultArgs: Partial<BSxTextAreaProps> = {
  item: undefined,
  hideLabel: false,
  labelPlacement: "top",
  labelWidth: 30,
