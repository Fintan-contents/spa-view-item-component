...
export const selectComponent = (
  ...
  if (item instanceof CsInputTextItem) {
    const props: AxProps<CsInputTextItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputNumberItem) {
    const props: AxProps<CsInputNumberItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsTextAreaItem) {
    const props: AxProps<CsTextAreaItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsCheckBoxItem) {
    const props: AxProps<CsCheckBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputPasswordItem) {
    const props: AxProps<CsInputPasswordItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsRadioBoxItem) {
    const props: AxProps<CsRadioBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsSelectNumberBoxItem) {
    const props: AxProps<CsSelectNumberBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsSelectBoxItem) {
    const props: AxProps<CsSelectBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsMultiCheckBoxItem) {
    const props: AxProps<CsMultiCheckBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputDateItem) {
    const props: AxProps<CsInputDateItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputNumberRangeItem) {
    const props: AxProps<CsInputNumberRangeItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputDateRangeItem) {
    const props: AxProps<CsInputDateRangeItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
