  ...
  return (
    <div className={getClassName(props, "bsx-button-area")}>
      ...
      <OverlayTrigger
        ...
        show={showTooltip}
        overlay={
          <Tooltip {...props.disabledTooltipProps}>
...
export const BSxButtonWithConfrim = (props: BSxButtonWithConfrimProps) => {
  ...
  if (!confirmOption) {
    ...
    return (
      <Button
        ...
        onClick={async () => {
          if (precheckClick) {
            const precheck = isPromise(precheckClick)
              ? await precheckClick()
              : precheckClick();
            if (precheck === false) {
              return;
  ...
  return (
    <>
      ...
      <Modal size="sm" show={showConfirm} centered>
        <Modal.Header>
          <Modal.Title>{confirmOption.title}</Modal.Title>
        </Modal.Header>
        <Modal.Body>{confirmOption.content}</Modal.Body>
        <Modal.Footer>
          <Button
            onClick={() => {
